...
# Add luci-app-vssr
git clone --depth=1 https://github.com/kenzok8/openwrt-packages/trunk/lua-maxminddb package/lean/lua-maxminddb
git clone --depth=1 https://github.com/281677160/openwrt-package/trunk/luci-app-vssr package/lean/luci-app-vssr
